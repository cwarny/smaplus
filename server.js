...
app.get("/tweets", function(req, res) {
	...
	if (req.query.user && req.query.user !== "null" && req.query.user !== null && req.query.user !== "undefined" && req.query.user !== undefined) filter["user.screen_name"] = req.query.user;
	if (req.query.q && req.query.q !== "null" && req.query.q !== null && req.query.q !== "undefined" && req.query.q !== undefined) filter["$text"] = { $search: req.query.q };
	...
	if (req.query.q && req.query.q !== "null" && req.query.q !== null && req.query.q !== "undefined" && req.query.q !== undefined) pipeline.push({ $sort: {score:-1}});
